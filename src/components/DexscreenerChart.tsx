...
export default function DexscreenerChart({ contractAddress }: DexscreenerChartProps) {
  ...
  return (
    <section id="chart" className="py-20 px-4 max-w-6xl mx-auto w-full relative">
      ...
      <div className="relative z-10 border border-babel-border bg-[#0a0a0a]/95 rounded-sm p-6 md:p-8 shadow-2xl backdrop-blur-md">
        {/* Section Title */}
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 pb-4 border-b border-babel-border">
          ...
          <div className="flex items-center gap-3 mt-4 md:mt-0 font-mono text-xs">
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-sm bg-[#111111] hover:bg-[#222222] border border-babel-border text-babel-gold hover:text-white transition duration-200 cursor-pointer font-bold uppercase tracking-wider"
              title="Reload Chart"
            >
            ...
            <a
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-sm bg-babel-gold/10 hover:bg-babel-gold/20 border border-babel-gold/30 text-babel-gold hover:text-white transition duration-200 uppercase tracking-wider font-bold"
            >
        ...
        {/* Chart Frame */}
        <div className="relative w-full aspect-[16/10] md:aspect-[21/9] min-h-[400px] rounded-sm overflow-hidden bg-[#050505] border border-babel-border shadow-inner">
          {isLoading && (
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-[#050505] text-babel-muted z-30">
              <div className="relative w-12 h-12 mb-4">
                <div className="absolute inset-0 rounded-full border-2 border-babel-gold/10"></div>
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6 font-mono text-xs text-babel-muted animate-fade-in">
          <div className="p-4 rounded-sm bg-[#080808] border border-babel-border">
          ...
          <div className="p-4 rounded-sm bg-[#080808] border border-babel-border flex flex-col justify-center">
            <span className="text-babel-gold uppercase block mb-1 font-bold">Ticker Mapping</span>
            <span className="text-white text-sm font-semibold">
              $babel <span className="text-[#444]">/</span> TOWER OF BABEL
            </span>
          </div>
          <div className="p-4 rounded-sm bg-[#080808] border border-babel-border flex flex-col justify-center">
